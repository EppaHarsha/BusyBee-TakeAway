...
const frappesSlurpeesSchema = new mongoose.Schema({
    title:String,
    image:{
        type:String,
...
const FrappesSlurpees = mongoose.model("FrappesSlurpees",frappesSlurpeesSchema);
module.exports=FrappesSlurpees;