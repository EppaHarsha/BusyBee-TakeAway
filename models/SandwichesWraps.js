...
const sandwichesWrapsSchema = new mongoose.Schema({
    title:String,
    image:{
        type:String,
...
const SandwichesWraps = mongoose.model("SandwichesWraps",sandwichesWrapsSchema);
module.exports=SandwichesWraps;